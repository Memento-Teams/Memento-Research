...
import { canShowRevertButton, revertDisabledTooltip } from './revert-gate.js';

const OMC_URL = window.location.origin;

window._tryRenderLcg = tryRenderLcg;
window._canShowRevertButton = canShowRevertButton;
window._revertDisabledTooltip = revertDisabledTooltip;
setupLcgHover();
